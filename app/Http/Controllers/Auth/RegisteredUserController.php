...
class RegisteredUserController extends Controller
{
    ...
    // Nanti perintah di bawah ini di komen aja, jgn di hapus (biar next periodenya enakk)
    // return redirect()->route('index')->with('show_early_bird_ended_announcement', true);
    ...
    public function create()
    {
        ...
        if ($now < $openDate) {
            // return redirect()->route('login')->with('gagal', 'Pendaftaran belum dibuka.');
        }
