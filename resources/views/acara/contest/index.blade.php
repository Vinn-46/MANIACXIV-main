        ...
        <div class="card rounded-lg shadow-md data relative">
            ...
            <div class="card-body bg-accent rounded-b-lg">
                ...
                <p class="text-slate-100 pb-3 sm:pb-0 break-words">
                    Anda dapat melihat <strong>Available Contest</strong>, <strong>Upcoming Contest</strong>, dan <strong>Finished Contest</strong> di sini.
                </p>
                <p class="font-medium alert alert-info py-2 rounded-md text-gray-800 bg-gray-200">
                ...
                <div role="alert" class="alert rounded-md py-2 text-gray-800 bg-gray-200">
                ...
                @elseif(session()->has('deleteGagalMasihAdaTeam'))
                    <div role="alert" class="alert alert-error mb-3 rounded-md">
                        <div class="flex flex-row justify-start items-center gap-x-2 w-full">
                            <svg xmlns="http://www.w3.org/2000/svg" class="stroke-white shrink-0 h-6 w-6" fill="none" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                            <span>Tidak Dapat Menghapus Contest <strong>{{ session()->get('deleteGagalMasihAdaTeam') }}</strong> Karena Masih Terdapat Team Yang Mengikuti Contests</span>
                        </div>
                    </div>
                @endif
                @error('name')
        ...
        <div class="card rounded-lg shadow-md data">
            ...
            <div class="card-body bg-accent rounded-b-lg">
                <div class="overflow-x-auto">
                    <table class="table">
                        <thead>
                        <tr class="bg-[#F0E9CF] text-secondary">
                            <th width="15%" class="text-center">Name</th>
                            <th width="15%" class="text-center">Type</th>
                            <th width="25%" class="text-center">Start Schedule</th>
                            <th width="25%" class="text-center">End Schedule</th>
                            <th width="10%" class="text-center">Author</th>
                            <th width="10%" class="text-center">
                                <button class="btn btn-outline btn-success btn-sm rounded-md px-5 py-0 w-full font-bold action" onclick="tambahContest()">
                                    Tambah
                                </button>
                            </th>
                        </tr>
