    ...
    <div class="c-bg-white shadow-2xl p-10 rounded-2xl max-w-[60vw] w-full text-center border-4 border-[#ae8350]">
        ...
        <div class="grid grid-cols-2 gap-10">
            ...
            <button onclick="window.location.href='{{ route('si.shop.index') }}'" class="bg-gradient-to-b from-[#e5d1b8] to-[#dba668] hover:from-[#dba668] hover:to-[#be8f57] border-4 border-[#733b22] rounded-3xl p-8 shadow-xl transition-all hover:-translate-y-2 group flex flex-col items-center justify-center">
                ...
                <h2 class="text-3xl font-['Lato'] font-extrabold text-[#733b22] tracking-wider">BLACK MARKET</h2>
                <p class="text-[#733b22] font-semibold mt-2 text-lg">Beli Peluru & Upgrade Senjata</p>
            </button>

            <!-- Tombol Target Base (Placeholder) -->
            <button onclick="alert('Fitur Target Base akan segera dikembangkan selanjutnya!')" class="bg-gradient-to-b from-[#e5d1b8] to-[#dba668] hover:from-[#dba668] hover:to-[#be8f57] border-4 border-[#733b22] rounded-3xl p-8 shadow-xl transition-all hover:-translate-y-2 group flex flex-col items-center justify-center relative overflow-hidden">
