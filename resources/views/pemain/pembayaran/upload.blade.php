...
@section("content")
    ...
    <p class="text-red-600 font-bold">Transfer melalui rekening BCA: 6150813016 a/n FRANSISKUS HENDRA SETIAWAN RONI</p>
    ...
    <table class="table">
        ...
        <tbody class="text-center">
            <tr>
                <td width="50%" class="font-medium">Batch Early Bird (5 Mei 2025 s/d 5 Juni 2025)</td>
                <td width="50%">Rp. 40.000/tim</td>
            </tr>
            <tr>
                <td width="50%" class="font-medium">Batch Normal (9 Juni 2025 s/d 16 Juli 2025)</td>
    ...
    <ul class="list-disc list-outside pl-5">
        ...
        <li>Setelah mengupload bukti transfer harap <strong>mengkonfirmasi</strong> ke contact person Whatsapp <a target="_blank" href="https://wa.me/+6285330001180" style="cursor: pointer !important;" class="font-bold text-primary">Gioshelyn Sanisa Leksono (085330001180)</a></li>
    </ul>
    <div class="divider my-0"></div>
