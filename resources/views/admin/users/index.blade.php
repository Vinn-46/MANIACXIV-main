    ...
    <div class="flex flex-col justify-center content-center w-full bg-light-cream  p-3 rounded-lg">
        ...
        <div class="overflow-auto" style="max-height: 450px">
            <table class="table table-xs table-pin-cols table-pin-rows">
                <thead>
                    <tr>
                        <th width="5%" class="text-center text-dark-brown py-3">ID</th>
                        <th width="30%" class="text-center text-dark-brown py-3">Nama</th>
                        <th width="30%" class="text-center text-dark-brown py-3">Username</th>
                        <th width="30%" class="text-center text-dark-brown py-3">Role</th>
            ...
            <div class="modal-box p-0">
                ...
                <form class="flex flex-col p-4 gap-y-3" action="{{ route('admin.users.store') }}" method="POST">
                    ...
                    <label class="form-control w-full">
                        ...
                        <div class="join">
                            <input type="password" placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;" class="input input-bordered rounded-md join-item w-5/6" name="password" id="password" />
                    ...
                    <label class="form-control w-full">
                        ...
                        <div class="join">
                            <input type="password" placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;" class="input input-bordered rounded-md join-item w-5/6" name="password_confirmation" id="password-confirm" />
                            <label class="swap swap-rotate join-item w-1/6 border border-warning rounded-md">
                                <!-- this hidden checkbox controls the state -->
