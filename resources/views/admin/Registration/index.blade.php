...
@section('content')
    <div class="text-sm breadcrumbs gap-1 flex items-center">
        <h1 class="text-xl font-semibold text-dark-brown">Admin</h1>
        <div class="divider divider-horizontal mx-0"></div>
        <ul class="text-light-brown">
            <li><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
            <li><a href="{{ route('admin.teams.index') }}" class="text-primary font-bold">Registration</a></li>
        </ul>
    </div>

    <div class="flex flex-col justify-center content-center w-full bg-light-cream p-3 rounded-lg">
        {{-- Alert --}}
        ...
        {{-- Header --}}
        <div class="flex flex-col gap-y-4 mt-2 mx-2">
            ...
            <form class="grid grid-cols-1 md:grid-cols-2 items-start w-full justify-between" method="GET" action="{{ route('admin.teams.search') }}">
                ...
                <div class="flex flex-col">
                    <p class="text-sm mb-1.5 font-semibold">Status</p>
                    <div class="flex flex-row gap-x-3">
                        <label class="label cursor-pointer gap-x-1">
                            ...
                            <span class="label-text font-semibold">Waiting</span>
                        </label>
                        <label class="label cursor-pointer gap-x-1">
                            ...
                            <span class="label-text font-semibold">Unverified</span>
                        </label>
                        <label class="label cursor-pointer gap-x-1">
                ...
                <div class="place-self-end mt-5 lg:mt-0">
                    <div class="text-sm mb-1.5 font-semibold">Search by</div>
                    <div class="flex flex-wrap">
                        <select class="select select-bordered rounded-none rounded-l-md font-semibold" name="search">
        ...
        <div class="divider my-8 mx-2">
            Teams
        </div>

        {{-- Teams --}}
        <div class="overflow-auto mx-2" style="max-height: 450px">
            <table class="table table-xs table-pin-cols table-pin-rows">
                <thead>
                    <tr>
                        <th width="5%" class="text-center text-dark-brown">ID</th>
                        <th width="20%" class="text-center text-dark-brown">Nama</th>
                        <th width="10%" class="text-center text-dark-brown">Status</th>
                        <th width="30%" class="text-center text-dark-brown">Peserta</th>
                        <th width="30%" class="text-center text-dark-brown">Sekolah</th>
                        <th width="5%" class="text-center text-dark-brown">Action</th>
                    </tr>
                </thead>
                <tbody id="tBody">
                    @foreach($teams as $team)
                        <tr>
                            @php
                                ...
                                else if ($team['status'] == 'unverified')
                                    $badgeColor = 'badge badge-warning';
                                else
                                    $badgeColor = 'badge badge-neutral';
                            @endphp
