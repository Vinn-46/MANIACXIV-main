...
<body>
    ...
    <aside id="logo-sidebar" class="fixed top-0 left-0 z-50 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
        <div class="h-full px-3 py-4 overflow-y-auto bg-pale-cream">
            ...
            <ul class="space-y-2 font-medium mt-4">
                <li class="">
                    <a href="{{ route('admin.dashboard') }}" class="flex items-center p-2 rounded-lg {{ $pageActive == "admin.dashboard" ? 'bg-cream text-dark-brown ' : 'hover:bg-gray-200 group text-white hover:text-base-content' }}">
                ...
                <li>
                    <a href="{{ route('admin.teams.index') }}" class="flex items-center p-2 rounded-lg {{ $pageActive == "admin.registration" ? 'bg-cream text-dark-brown ' : 'hover:bg-gray-200 group text-white hover:text-base-content' }}">
                ...
                <li>
                    <a href="{{ route('admin.users.index') }}" class="flex items-center p-2 rounded-lg {{ $pageActive == "admin.users" ? 'bg-cream text-dark-brown ' : 'hover:bg-gray-200 group text-white hover:text-base-content' }}">
    ...
    <div class="p-4 sm:ml-64">
        {{-- Navbar --}}
        <div class="navbar bg-dark-brown sticky top-3 rounded-md mb-4 px-4 z-40 justify-between">
            {{-- Page --}}
            <div class="flex justify-center items-center gap-2">
                ...
                <div class="flex-1 text-xl text-primary-content uppercase font-semibold text-bone">
                    {{ $pageTitle ?? "Dashboard" }}
                </div>
            </div>
            ...
            <div class="flex-none">
                <div class="dropdown dropdown-end">
                    <div tabindex="0" role="button" class="btn btn-ghost btn-circle avatar">
                        <div class="w-10 h-10 rounded-full bg-light-brown flex items-center justify-center">
                    ...
                    <ul tabindex="0" class="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-cream text-dark-brown rounded-box w-52 font-semibold">
                        <li>
