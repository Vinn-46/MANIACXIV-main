...
// Kalau web dalam perbaikan pakai ini
// Route::get('/', function () {
...
Route::group(
    ...
    function () {
        ...
        Route::get('/rallyGame/{rallyGame}', [SuperSI\SuperSIController::class, 'rallyDetail'])
            ->name('rally.detail');
        Route::put('/rallyGame/{rallyGame}/{score}/score/update', [SuperSI\SuperSIController::class, 'updateScore']);
        Route::delete('/rallyGame/{rallyGame}/{score}/score/delete', [SuperSI\SuperSIController::class, 'deleteScore']);
        ...
        Route::post('/player/{player}/score/create/{rallyGame}', [SuperSI\PlayerController::class, 'createScore'])
            ->name('player.create-score');
        Route::put('/player/score/update/{score}', [SuperSI\PlayerController::class, 'updateScore'])
            ->name('player.update-score');
        Route::delete('/player/score/delete/{score}', [SuperSI\PlayerController::class, 'deleteScore'])
            ->name('player.delete-score');
        ...
        // ===== NOTIFICATION =====
        Route::get('/notification', [SuperSI\NotificationController::class, 'index'])
            ->name('notification.index');
        Route::patch('/notification/{notification}/resolve', [SuperSI\NotificationController::class, 'resolve'])
            ->name('notification.resolve');
        Route::get('/notification/unread-count', function () {
            return response()->json([
                'count' => Notification::where('resolved', false)->count()
            ]);
        ...
        // ===== BACKUP DB =====
        Route::get('/backup-db', [BackupDatabaseController::class, 'backupDatabase'])
        ->name('backup.db');
    }
);
